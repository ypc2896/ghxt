...
<html>
<head>
	<title>太原市工会医疗互助信息管理系统登录页面</title>
    ...
    <td align="center">
      <div class="login">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right" width="161">
                    <input type="text" name="logincode" value="admin" style="width:150px;height:20px" />
                  </td>
                ...
                <tr>
                  ...
                  <td align="right" width="161">
                    <input type="password" name="password" value="123456" style="width:150px;height:20px" />
                  </td>
                  <td align="center" height="29">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:8px;">
          ...
          <tr>
            <td align="center">太原市工会医疗帮扶中心</td>
          </tr>
        </table>
      </div>
      <!--login -->
