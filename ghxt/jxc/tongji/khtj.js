    ...
    var djmxGrid = new Ext.grid.GridPanel({
        ...
        cm: new Ext.grid.ColumnModel({
			...
			columns:[new Ext.grid.RowNumberer(),
	            ...
	            {header: '是否付款', width: 100, sortable:true, align:'center', dataIndex: 'jystate',
	            	renderer : function(v) {return v==0?"未付":"已付";}
	            },
	            {header: '应付金额', width: 100, sortable:true, align:'right', renderer:zhMoney, dataIndex: 'yfje'},
	            {header: '实付金额', width: 100, sortable:true, align:'right', renderer:zhMoney, dataIndex: 'sfje'},
