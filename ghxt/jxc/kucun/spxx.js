        ...
        tbar:[{
        	...
        	handler: function(){
				...
				if(!record){
					...
					addJhForm.getForm().findField("scjj").setRawValue("￥"+record.get("scjj"));
					addJhForm.getForm().findField("cbj").setRawValue(record.get("scjj"));
				}
        	}
        },"-",{
        	text:"增加",
	...
	var addJhsp = function(){
		...
		djForm.findField("yfje").setValue(yfje+zj);
		djForm.findField("sfje").setValue(yfje+zj);
	}
