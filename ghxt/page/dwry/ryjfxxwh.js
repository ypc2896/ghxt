...
Ext.onReady(function(){
	...
	var store = new Ext.data.JsonStore({
		...
		v_lbid="0";   //将左侧的全局变量设为全部
		if (f.isValid()) {
			var params = f.getValues();
			params.start=v_start;
			params.limit =v_limit;}
			//store.load({params:params});
	    a.baseParams={start:v_start, limit:v_limit,aab001:v_lbid,startdate:params.startdate,enddate:params.enddate,aae005:params.aae005};//aae062为期别，期别查询与缴费状态树邦定。
	    }
