...
Ext.onReady(function(){
	...
	Ext.QuickTips.init();
	 var v_lbid="0", v_lbname="", v_start=0, v_limit=10,v_gwgl="fsgw",v_cybz="100";
	...
	var RylszfxxObj = [
			{name:'zf001',type:'string'},  
			{name:'zf002',type:'string'},  
			{name:'zf003',type:'string'},  
			{name:'zf004',type:'string'},  
			{name:'zf005',type:'string'},  
			{name:'zf006',type:'float'},   
			{name:'zf007',type:'float'},   
			{name:'zf008',type:'float'},   
			{name:'zf009',type:'float'},   
			{name:'zf010',type:'float'},   
			{name:'zf011',type:'float'},   
			{name:'zf012',type:'string'},  
			{name:'zf013',type:'float'},   
			{name:'zf014',type:'float'},   
			{name:'zf015',type:'string'},  
			{name:'zf016',type:'string'},  
			{name:'zf017',type:'string'},  
			{name:'zf018',type:'string'},  
			{name:'zf019',type:'string'},  
			{name:'zf020',type:'string'},  
			{name:'zf021',type:'string'},  
			{name:'zf022',type:'string'},  
			{name:'zf023',type:'string'},  
			{name:'zf024',type:'string'},  
			{name:'zf025',type:'string'},  
			{name:'zf026',type:'string'},  
			{name:'zf027',type:'string'},  
			{name:'zf028',type:'string'},  
			{name:'zf029',type:'string'},  
			{name:'zf030',type:'float'},   
			{name:'zf031',type:'float'},   
			{name:'zf032',type:'string'} 
	...
	var store = new Ext.data.JsonStore({
	    url: 'rylszfxx_findPageRylszfxx.do',
	    root: 'root',
	    totalProperty: 'total',
		...
		if (f.isValid()) {
			...
			//store.load({params:params});
	    a.baseParams={start:v_start, limit:v_limit,gwgl:v_gwgl,zf032:v_cybz,startdate:params.startdate,enddate:params.enddate,zf002:params.zf002};//aae062为期别，期别查询与缴费状态树邦定。
	    }
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        cm: new Ext.grid.ColumnModel({
			...
			columns:[new Ext.grid.RowNumberer(),
	            ...
	            {header: '期别', width: 40,sortable:true, align:'center', dataIndex: 'zf002'},
	            {header: '批次', width: 60,sortable:true,  align:'center', dataIndex: 'zf003'},
	            {header:'病案起始编号',width:80,sortable:true, align:'center',dataIndex:'zf004'},
	            {header: '病案截止编号', width: 80, sortable:true, align:'center',dataIndex: 'zf005'},
	            {header:'应支付人数',width:80,sortable:true, align:'center',dataIndex:'zf006'},
	            {header: '应支付金额', width:80, sortable:true, align:'center',dataIndex: 'zf007'},
				{header:'实际支付人数',width:80,sortable:true, align:'center',dataIndex:'zf010'},
				{header:'实际支付金额',width:80,sortable:true, align:'center',dataIndex:'zf011'}, 
				
								
				{header:'支出单据',width:60,sortable:true, align:'center',dataIndex:'zf027'},
 
				{header:'业务类型',width:60,sortable:true, align:'center',dataIndex:'zf012',
									renderer: function(v){
				                 	var str="";
				                 	switch(v){ 
				                 	case '0': str='互助';  break;
				...
				{id:'zf028', header:'支出银行 ',width:60,align:'center',dataIndex:'zf028'},   
				{ header:'支前累计支出',width:80,align:'center',dataIndex:'zf030'},   
				{ header:'期内累计支出',width:80,align:'center',dataIndex:'zf031'},   
				...
				{ header:'审批',width:60,align:'center',sortable:true,dataIndex:'zf032',
				                 renderer: function(v){
				                 	var str="";
				                 	switch(v){ 
...
                 }  
        ...
        listeners:{
        	rowclick:function(a,b){
        		...
        		//ycmxstore.removeAll();
         		//alert(b);
         		  ycmxstore.load({params:{zfb003:gwrecord1.get("zf003"),sae005:gwrecord1.get("zf002"),start:v_start, limit:v_limit}});
...
                    width:125,
                    listeners:{        	
        		        ...
        		        //更新数据
        		        store.load({params:{start:v_start, limit:v_limit,zf032:v_cybz}});
...
var RylsxxObj = [
			...
			{name:'zfb003',type:'string'},
			{name:'zfb027',type:'string'}
        ...
        cm: new Ext.grid.ColumnModel({
			...
			columns:[new Ext.grid.RowNumberer(),
			   //smm,
	            ...
	            {header: '批次', width: 60,sortable:true,  align:'center', dataIndex: 'zfb003'},
	            
	            {header: '病案编号', width: 60,sortable:true,  align:'center', dataIndex: 'sae099'},
