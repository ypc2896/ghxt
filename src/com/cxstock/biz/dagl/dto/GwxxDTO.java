...
//	  private String lxr000; //共享标志
	  private String bz0000;//公文备注
	  private Integer lbid;  //机构ID
	  private String lbname; //机构名称  
	  ...
	  public GwxxDTO() {
		...
		public GwxxDTO(String dwbh00,String bz0000, Integer lbid, String lbname,
				Integer userid,String username,String gw001,String gw002,String gw003,
				String gw004,String gw005,Date gw006,String gw007,String gw008,String gw009,
				String gw010,Date gw011,Date gw012,String gw013,String gw014) {
			super();
			this.dwbh00 = dwbh00;
//			this.dwmc00 = dwmc00;
//			this.dhua00 = dhua00;
...
//			this.lxr000 = lxr000;
			...
			this.gw011 = gw011;//录入日期          
			this.gw012 = gw012;//归档日期          
