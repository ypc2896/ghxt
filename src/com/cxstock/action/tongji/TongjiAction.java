...
public class TongjiAction extends BaseAction  {
	...
	public String findGysTj(){
		try {
			...
			if(startdate!=null&&enddate!=null){
				wheres.append(" and to_char(t.riqi,'yyyy-mm-dd') between '");
			...
			if(jystate!=null&&!"".equals(jystate)){
			 ...
			 wheres.append(" order by t.riqi desc ");
	...
	public String findSpcgTj(){
		try {
			...
			if(startdate!=null&&enddate!=null){
				wheres.append(" and to_char(t.jhd.riqi,'yyyy-mm-dd') between '");
				wheres.append(startdate);
				wheres.append("' and '");
				wheres.append(enddate);
				wheres.append("'");
			...
			if(search!=null&&!"".equals(search)){
			 ...
			 wheres.append(" order by t.jhd.riqi desc ");
	...
	public String findSpxstj(){
		try {
			StringBuffer wheres = new StringBuffer("where 1=1");
			if(startdate!=null&&enddate!=null){
				wheres.append(" and  to_char(t.ckd.riqi,'yyyy-mm-dd') between '");
				wheres.append(startdate);
				wheres.append("' and '");
				wheres.append(enddate);
				wheres.append("'");
			...
			if(search!=null&&!"".equals(search)){
			 ...
			 wheres.append(" order by t.ckd.riqi desc ");
	...
	public String findTjfxRi(){
		try {
			...
			if(startdate!=null&&enddate!=null){
				...
				wheres.append(" and   t.riqi  between  to_date('");
				wheres.append(startdate);
				wheres.append("','yyyy-mm-dd')");
				wheres.append("  and to_date('");
				wheres.append(enddate);
				wheres.append("','yyyy-mm-dd')");
