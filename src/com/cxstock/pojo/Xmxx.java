...
public class Xmxx implements java.io.Serializable {
	...
	public Xmxx(String spid) {
		this.spid = spid;
	}

	/** minimal constructor */
	public Xmxx(String spname, Integer lbid, String lbname) {
		this.spname = spname;
		this.lbid = lbid;
		this.lbname = lbname;
	}
	...
	/** full constructor */
	public Xmxx(String spid,String spname, String xinghao, Integer lbid, String lbname,
